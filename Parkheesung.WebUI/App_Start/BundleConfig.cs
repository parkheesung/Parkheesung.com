...
namespace Parkheesung.WebUI
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Style/Base").Include("~/Content/PopLayer.css", "~/Content/Loading.css"));
            bundles.Add(new StyleBundle("~/Style/bootstrap").Include("~/Content/bootstrap.css", "~/Content/css/bootflat.css", "~/Content/Site.css"));
